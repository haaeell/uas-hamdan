    ...
    <div class="min-h-screen bg-[#f8f9fb] text-gray-950">
        ...
        <main class="mx-auto grid w-full max-w-6xl gap-8 px-5 pb-10 pt-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:pt-10">
            <section class="max-w-xl">
                ...
                <div class="mt-8 space-y-5 border-l border-gray-200 pl-5 text-sm">
                    <div>
                        <p class="font-semibold text-gray-900">1. Isi identitas</p>
                        <p class="mt-1 leading-6 text-gray-500">Gunakan nama lengkap dan email aktif yang bisa diverifikasi.</p>
                    </div>

                    <div>
                        <p class="font-semibold text-gray-900">2. Verifikasi OTP</p>
                        <p class="mt-1 leading-6 text-gray-500">Kode verifikasi dikirim ke email setelah form dikirim.</p>
                    </div>

                    <div>
                        <p class="font-semibold text-gray-900">3. Review admin</p>
            ...
            <section class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                <div class="mb-8 flex items-start justify-between gap-4">
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-widest text-blue-600">Daftar</p>
                        <h2 class="mt-1 text-2xl font-bold text-gray-950">Buat akun baru</h2>
