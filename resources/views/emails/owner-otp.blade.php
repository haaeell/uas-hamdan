                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px; background:#ffffff; border:1px solid #e2e8f0; border-radius:20px; overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(135deg, #dc2626, #b91c1c); padding:28px 32px; color:#ffffff;">
                            <div style="font-size:12px; letter-spacing:1px; text-transform:uppercase; font-weight:700; opacity:0.9;">Verifikasi Email</div>
                            <div style="font-size:28px; line-height:1.2; font-weight:800; margin-top:10px;">Kode OTP Anda</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <div style="margin:0 0 24px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:18px; padding:22px; text-align:center;">
                                <div style="font-size:12px; text-transform:uppercase; letter-spacing:1px; color:#64748b; font-weight:700; margin-bottom:10px;">Kode OTP</div>
                                <div style="font-size:34px; letter-spacing:8px; font-weight:800; color:#dc2626;">{{ $otpCode }}</div>
                            </div>
                                ...
                                <tr>
                                    <td style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px; padding:20px;">
                                        <div style="font-size:14px; line-height:1.8; color:#0f172a;">
                                            ...
                                            <strong>Berlaku sampai:</strong> {{ optional($owner->email_otp_expires_at)->format('d M Y, H:i') }}
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="border-radius:12px; background:#dc2626;">
                                            <a href="{{ $verifyUrl }}" style="display:inline-block; padding:14px 22px; color:#ffffff; text-decoration:none; font-weight:700; font-size:15px;">Buka Halaman Verifikasi</a>
                                        </td>
                                    </tr>
                                </table>
                            @endif
